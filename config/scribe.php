...
return [
    ...
    'title' => 'Parfum Store API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'RESTful API untuk Sistem Toko Online Parfum (Mini E-Commerce). Mendukung autentikasi, CRUD produk & kategori, transaksi, file upload, pagination, dan pencarian.',
    ...
    'auth' => [
        ...
        'extra_info' => 'To authenticate, first call the **Login** endpoint to get a Bearer token. Then include it in the `Authorization` header as: `Bearer {token}`.',
    ],
